...
Public Class DatabaseForm
    ...
    Private Sub DatabaseForm_FormClosing(sender As Object, e As FormClosingEventArgs) Handles Me.FormClosing
        Me.PlayerTableBindingSource.EndEdit()
        Me.PlayerTableTableAdapter.Update(Me.PlayerDatabaseDataSet.PlayerTable)
    End Sub
